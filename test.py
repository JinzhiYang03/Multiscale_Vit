...
def plot_accuracy(scaling_factors, accuracies, with_spp=False):
    save_path="accuracy_vs_scaling.png"
...
def main():
    ...
    plot_accuracy(scaling_factors, accuracies, (args.model_type == "Vit_SPP"))
